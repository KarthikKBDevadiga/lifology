...
export default function OrangeZone({ profile, token }) {
    ...
    return (
        <>
            <MetaLayout title="Orange Zone" description="Orange Zone" />
                                        ...
                                        <div className="space-y-6 lg:col-start-1 lg:col-span-2">
                                            ...
                                            <section aria-labelledby="applicant-information-title" >
                                                ...
                                                <div className="bg-white rounded-md shadow mt-4 p-4">
                                                    ...
                                                    <div className="relative w-full border rounded-md shadow-sm pl-3 pr-10 py-2 mt-4 text-left cursor-default outline-none focus:outline-none focus:border-indigo-700 sm:text-sm border border-gray-300 " style={{ background: '#ED872F' }} >
                                                        <span className="font-medium block truncate text-white">Orange Zone</span>
                                                        <span className="absolute inset-y-0 right-0 flex items-center pl-2 pr-2 ">
                                                                ...
                                                                <div className="p-1 bg-white  rounded-full">
                                                                    {
                                                                        openOrange ?
                                                                            ...
                                                                            <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="#ED872F">
                                                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                                                                            </svg> :
                                                                            <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="#ED872F">
                                                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
