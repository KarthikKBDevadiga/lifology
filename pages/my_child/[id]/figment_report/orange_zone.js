                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="grid grid-cols-1 gap-4">
                                    ...
                                    <div className="bg-white rounded-md shadow mt-5 pb-9 h-auto">
                                        ...
                                        <div style={{ background: "#5EB570" }} className="p-2 mt-5 mr-5 ml-5 text-white text-medium items-center border rounded-md font-medium">Orange Zone
                                            {openOrange ? <span onClick={() => setOrangeOpen(!openOrange)} style={{ position: "absolute", right: "55%", cursor: "pointer" }} className="content-end text-green-500 bg-white text-large  px-1.5 rounded-full h-5 w-15  ">{'-'}</span> :
                                                <span onClick={() => setOrangeOpen(!openOrange)} style={{ position: "absolute", right: "55%", cursor: "pointer" }} className="content-end text-green-500 bg-white text-large  px-1.5 rounded-full h-6 w-15  ">{'+'}</span>}
                                        </div>
                                        {openOrange && <div className="p-2 mb-5 mr-5 ml-5 bg-white text-medium items-center border  font-medium">orange Zone Data</div>}

                                        <div className="p-2 mt-5 mr-5 ml-5 bg-white text-medium items-center border rounded-md font-medium">Purple Zone
                                            {openPurple ? <span onClick={() => setPurpleOpen(!openPurple)} style={{ position: "absolute", right: "55%", cursor: "pointer" }} className="content-end text-white bg-black text-large  px-1.5 rounded-full h-5 w-15 ">{'-'}</span> :
                                                <span onClick={() => setPurpleOpen(!openPurple)} style={{ position: "absolute", right: "55%", cursor: "pointer" }} className="content-end  text-white bg-black text-large  px-1.5 rounded-full h-6 w-15">{'+'}</span>}
                                        </div>
                                ...
                                <div className="grid grid-cols-1 gap-4">
                                    ...
                                    <div className="bg-white rounded-md shadow h-auto p-5">
                                        <div className="text-white m-2 rounded-md" style={{ background: "#ED872F" }}>
                                            <p className="p-5"><span style={{color:"#c1712b"}} className=" text-medium text-orange-500 bg-white mr-2 p-1 py-2 rounded-full h-12 w-9 ">90%</span>Tourism & Hospitality</p>
                                            <p className="text-sm pl-5 pb-3">Personality Match</p>
                                            <div class="relative ml-5 mr-5  pt-1">
                                                <div style={{background:"#c1712b"}} className="overflow-hidden h-2 mb-4 text-xs flex rounded">
                                        ...
                                        <div className="text-white m-2 pb-5 rounded-md" style={{ background: "#ED872F" }}>
                                            <p className="p-5"><span style={{color:"#c1712b"}} className="text-medium text-orange-500 bg-white mr-2 p-1 py-2 rounded-full h-12 w-9 ">90%</span>Tourism & Hospitality</p>
                                            <p className="text-sm pl-5 pb-3">Personality Match</p>
                                            <div class="relative ml-5 mr-5  pt-1">
                                                <div style={{background:"#c1712b"}} className="overflow-hidden h-2 mb-4 text-xs flex rounded ">
                                            ...
                                            <p className="text-sm pl-5 pb-3">Orientation Match</p>
                                            <div class="relative ml-5  mr-5 pt-1">
                                                <div style={{background:"#c1712b"}} className="overflow-hidden h-2  text-xs flex rounded">
                                                    <div style={{ width: '70%' }} className="shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center bg-white"></div>
                                                </div>
                                            </div>
