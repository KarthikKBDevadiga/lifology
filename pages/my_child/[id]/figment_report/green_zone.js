                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="grid grid-cols-1 gap-4">
                                    ...
                                    <div className="bg-white rounded-md shadow mt-5 pb-9 h-auto">
                                        ...
                                        <div style={{ background: "#5EB570" }} className="border mt-5 mr-5 ml-5 rounded-md p-2 w-auto text-white -mt-5 items-center  font-medium">
                                            Green Zone
                                            {openGreen ? <span onClick={() => setGreenOpen(!open)} style={{ position: "absolute", right: "55%", cursor: "pointer" }} className="content-end bg-white text-large text-green-500 px-1.5 rounded-full h-5 w-15 px-3 ">{'-'}</span> :
                                                <span onClick={() => setGreenOpen(!openGreen)} style={{ position: "absolute", right: "55%", cursor: "pointer" }} className="fixed content-end bg-white text-large text-green-500 px-1.5 rounded-full h-6 w-15 ">{'+'}</span>}
                                        </div>
                                        ...
                                        <div className="p-2 mt-5 mr-5 ml-5 bg-white text-medium items-center border rounded-md font-medium">Orange Zone
                                ...
                                <div className="grid grid-cols-1 gap-4">
                                    ...
                                    <div className="bg-white rounded-md shadow h-auto p-5">
                                        <div className="text-white m-2 rounded-md" style={{ background: "#5EB570" }}>
                                            <p className="p-5"><span className="text-green-500 bg-white mr-2 p-1 py-2 rounded-full h-12 w-9 ">90%</span>Tourism & Hospitality</p>
                                        ...
                                        <div className="text-white m-2 pb-5 rounded-md" style={{ background: "#5EB570" }}>
                                            <p className="p-5"><span className="text-green-500 bg-white mr-2 p-1 py-2 rounded-full h-12 w-9 ">90%</span>Tourism & Hospitality</p>
                                            <p className="text-sm pl-5 pb-3">Personality Match</p>
                                            <div class="relative ml-5 mr-5  pt-1">
                                                <div className="overflow-hidden h-2 mb-4 text-xs flex rounded bg-green-800">
                                            ...
                                            <p className="text-sm pl-5 pb-3">Orientation Match</p>
                                            <div class="relative ml-5  mr-5 pt-1">
                                                <div className="overflow-hidden h-2  text-xs flex rounded bg-green-800">
                                                    <div style={{ width: '70%' }} className="shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center bg-white"></div>
                                                </div>
                                            </div>
