                        ...
                        <div className="m-4 font-sans">
                            <div className="grid grid-cols-2 gap-4">
                                <div className="grid grid-cols-1 gap-4">
                                    ...
                                    <div className="bg-white rounded-md shadow mt-0 pb-9 h-auto">
                                        ...
                                        <div style={{ background: "#5EB570" }} className="p-2 mt-5 mr-5 ml-5 text-white text-medium items-center border rounded-md font-medium">Blue Zone
                                            {openBlue ? <span onClick={() => setBlueOpen(!openBlue)} style={{ position: "absolute", right: "55%", cursor: "pointer" }} className="content-end bg-white text-green-500 text-large  px-1.5 rounded-full h-5 w-15  ">{'-'}</span> :
                                                <span onClick={() => setBlueOpen(!openBlue)} style={{ position: "absolute", right: "55%", cursor: "pointer" }} className="content-end bg-white text-large text-green-500 px-1.5 rounded-full h-6 w-15  ">{'+'}</span>}
                                        </div>
                                ...
                                <div className="grid grid-cols-1 gap-4">
                                    ...
                                    <div className="bg-white rounded-md shadow h-auto p-5">
                                        <div className="text-white m-2 rounded-md" style={{ background: "#61B9FF" }}>
                                        ...
                                        <div className="text-white m-2 pb-5 rounded-md" style={{ background: "#61B9FF" }}>
                                            <p className="p-5"><span className="text-medium text-blue-500 bg-white mr-2 p-1 py-2 rounded-full h-12 w-9 ">90%</span>Tourism & Hospitality</p>
                                            <p className="text-sm pl-5 pb-3">Personality Match</p>
                                            <div class="relative ml-5 mr-5  pt-1">
                                                <div className="overflow-hidden h-2 mb-4 text-xs flex rounded bg-blue-800">
