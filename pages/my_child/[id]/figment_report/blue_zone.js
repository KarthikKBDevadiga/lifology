...
export default function BlueZone({ profile, token }) {
    ...
    return (
        <>
            <MetaLayout title="Blue Zone" description="Blue Zone" />
                                    ...
                                    <div className="max-w-3xl mx-auto grid grid-cols-1 gap-4 lg:max-w-7xl lg:grid-flow-col-dense lg:grid-cols-4">
                                        <div className="space-y-6 lg:col-start-1 lg:col-span-2">
                                            ...
                                            <section aria-labelledby="applicant-information-title" >
                                                ...
                                                <div className="bg-white rounded-md shadow mt-4 p-4">
                                                    ...
                                                    <div className="relative w-full border rounded-md shadow-sm pl-3 pr-10 py-2 mt-4 text-left cursor-default outline-none focus:outline-none focus:border-indigo-700 sm:text-sm border border-gray-300 " style={{ background: "#61B9FF" }} >
                                                        <span className="font-medium block truncate text-white">Blue Zone</span>
                                                        <span className="absolute inset-y-0 right-0 flex items-center pl-2 pr-2 ">
                                                                ...
                                                                <div className="p-1 bg-white  rounded-full">
                                                                    {
                                                                        openBlue ?
                                                                            ...
                                                                            <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="#61B9FF">
                                                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                                                                            </svg> :
                                                                            <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="#61B9FF">
                                                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                                        ...
                                        <section aria-labelledby="timeline-title" className="lg:col-start-3 lg:col-span-2">
                                            ...
                                            <div className="bg-white rounded-md shadow h-auto p-4">
                                                <div className="text-white rounded-md mb-4" style={{ background: "#61B9FF" }}>
                                                ...
                                                <div className="text-white pb-4 rounded-md" style={{ background: "#61B9FF" }}>
