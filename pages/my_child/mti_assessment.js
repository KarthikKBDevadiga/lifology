                                        ...
                                        <div className="lg:col-start-1 lg:col-span-2">
                                            <div className="bg-white align-middle min-w-full overflow-x-auto shadow overflow-hidden sm:rounded-lg p-4">
                                                ...
                                                <div className="mt-4 text-sm text-justify leading-loose">
                                                    Do you think your child has mastery over their immediate environment? this behavioral assessment measure how your child deals with the world and their immediate environment
                                                </div>
                                                ...
                                                <button
                                                    type="submit"
                                                    className="mt-4 ml-auto flex justify-center py-2 px-4 border border-transparent rounded-full shadow-sm text-sm font-medium text-white bg-lblue hover:bg-indigo-700 focus:outline-none">
                                                    Start Assesment
                                                </button>
                                            </div>
