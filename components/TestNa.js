...
const TestNa = ({ index, sidebarOpen, setSidebarOpen, isPackagePurhased }) => {
                    ...
                    <div className="flex flex-col flex-grow bg-cyan-700 pt-5 pb-4 overflow-y-auto">
                        ...
                        <nav className="mt-5 flex-1 flex flex-col divide-y divide-cyan-800 overflow-y-auto relative" aria-label="Sidebar">
                            <div className="px-4 space-y-1 mt-4">
                                <Link activeClass="active " className={classNames(
                                    index == 2 ? 'text-white bg-lblue' : 'text-black bg-white hover:bg-indigo-100',
                                    "test2 font-medium text-sm p-2 rounded-md items-center flex duration-500"
                                )} to="test2" spy={true} smooth={true} duration={500} >
                                    Test 1</Link>
                            </div>
